...
class Post(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="发布者")
    is_hot = models.BooleanField(default=False, verbose_name="是否热门")   # 手动热门推荐

    pv = models.IntegerField(default=0,verbose_name="阅读量")  # 浏览量
    add_date = models.DateTimeField(auto_now_add=True, verbose_name="发布时间")
    pub_date = models.DateTimeField(auto_now=True, verbose_name="修改时间")
...
class SideBar(models.Model):
    ...
    display_type = models.PositiveIntegerField(default=1, choices=DISPLAY_TYPE, verbose_name="显示类型")
